...
static void MX_SAI2_Init(void)
{
	...
	// and hsai_BlockB2.SlotInit.SlotActive=0x000A for MicIn.
	...
	// Keep in mind that any change here must be coherent with the argument given to start_Audio_Processing(), see audio.c
...
void startUITask(void const * argument)
{
	...
	for(;;)
	{
		...
		/*uiSliderDelay();
		uiDisplaySpectrum(); //graphique spectre
		uiSliderFeed();
		uiSliderVolume();
		uiSliderFlanger();*/
